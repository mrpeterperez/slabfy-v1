// 🤖 INTERNAL NOTE:
// Minimal columns popover for Inventory V2 (kept local to inventory-table per slabfyrules)
// Exports: InventoryV2ColumnsPopover
...
export function InventoryV2ColumnsPopover({ open, onOpenChange, columns, onToggle, onReset, showReset }: Props) {
  return (
...
export default InventoryV2ColumnsPopover;
