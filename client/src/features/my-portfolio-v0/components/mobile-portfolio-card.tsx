...
export function MobilePortfolioCard({ asset, market, index, onClick }: MobilePortfolioCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-x-auto overflow-y-hidden h-7 flex items-center scrollbar-hide mt-2" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        <motion.div
          className="flex items-center gap-3 text-xs text-muted-foreground whitespace-nowrap"
          animate={{
            x: [0, -1500]
          }}
          transition={{
